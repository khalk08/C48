//task for today: 
// 1) make food disappear when they touch the boy, 
// 2) food and score count shoudld be stated the exact value in the end
...
function draw(){
  ...
  if(gameState === 2){
    ...
    textSize(30)
    fill("black")
    text("Food Count: " +foodCount ,200, 270 );

    textSize(30)
    fill("black")
    text("Score: " +score, 200, 310 );
...
//1)glitch in gameState 0
//2)food isnt destroying
//3)running animation
//4)the 2 diamonds in the beginning 
